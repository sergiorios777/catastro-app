...
namespace App\Filament\App\Resources\Contribuyentes\RelationManagers;
...
class BeneficiosRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                CreateAction::make()
                    ->modalHeading('Asignar Nuevo Beneficio')
                    ->mutateFormDataUsing(function (array $data) {
                        // Asegurar el tenant_id si es necesario, 
                        // aunque Filament suele manejar relaciones automáticamente.
                        // Si da error de tenant_id null, descomenta esto:
