                ...
                Section::make('Dirección Fiscal')
                    ...
                    ->schema([
                        TextInput::make('direccion')
                            ...
                            ->maxLength(255)
                            ->required(),
                        TextInput::make('zona_sector')
                            ->maxLength(100)
                            ->statePath('ubicacion_geografica.zona_sector'),
                        TextInput::make('denominacion_urbana')
                            ->maxLength(100)
                            ->statePath('ubicacion_geografica.denominacion_urbana'),
                        FusedGroup::make()
                            ...
                            ->schema([
                                TextInput::make('manzana')
                                    ->placeholder('Mza.')
                                    ->statePath('ubicacion_geografica.manzana'),
                                TextInput::make('lote')
                                    ->placeholder('Lote')
                                    ->statePath('ubicacion_geografica.lote'),
                            ]),
                        TextInput::make('referencia')
                            ->columnSpanFull()
                            ->label('Referencias')
                            ->maxLength(255)
                            ->statePath('ubicacion_geografica.referencia'),
